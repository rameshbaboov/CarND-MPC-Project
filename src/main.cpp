...
int main() {
  ...
  h.onMessage([&mpc](uWS::WebSocket<uWS::SERVER> ws, char *data, size_t length,
    ...
    if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
	  ...
	  cout << "main.cpp: retrieving jSON Objects " << endl;
	  ...
	  vector<double> waypoints_x;
	    ...
	    cout << "main.cpp: transforming waypoints from car's perspective " << endl;
	  ...
	  // fit polynomial to the third degree
	  auto coeffs = polyfit(waypoints_x_eig, waypoints_y_eig, 3);

	  // define actuator delay
	  ...
	  cout <<" main.cpp: initiating mpc.solve" << endl;
          auto vars = mpc.Solve(state, coeffs);
	  cout <<" main.cpp:  mpc solveD" << endl;
